...
<div>
  ...
  <div class="container mx-auto px-4 mb-12">
    ...
    <div class="sm:w-1/3 mx-auto">
      ...
      <div class="flex">
        <button class="px-4 py-2 rounded-sm hover:bg-white hover:text-secondary font-bold border-2 border-secondary bg-secondary text-white focus:outline-none">Register</button>
